    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ marginBottom: "3rem" }}>
          ...
          내 마음의 전체화면은 앞선 결과를 다시 요약하지 않습니다.<br/>답들 사이에서 반복되는 흐름과, 유난히 다르게 빛나는 지점을 함께 봅니다.<br/><br/>나는 어디에서 익숙한 나로 돌아갔고,<br/>어디에서 다른 가능성을 보였을까요?<br/><br/>이제 흩어져 있던 답들이 하나의 장면으로 모입니다.</p>
         </div>
